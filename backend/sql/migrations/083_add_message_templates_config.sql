...
('promo', 'enabled', 'true', 'Include promo message in email campaigns', 'boolean', TRUE),
('promo', 'subject', 'Exclusive Offer — {percent}% Off Your Next Service', 'Subject line for promo emails', 'string', TRUE),
('promo', 'greeting', 'Hey {customer_name}! We have an exclusive offer just for you. Use code {code} for {percent}% off your next service.', 'Opening message for promo email', 'string', TRUE),
('promo', 'reminders', 'This offer is valid for {days} days only.\nMinimum purchase of ₱{min_purchase} required.\nPromo code cannot be combined with other offers.', 'Terms and conditions for promo offer (JSON array)', 'string', TRUE),
('promo', 'closing', 'Don''t miss out! Claim your discount today and give your vehicle the care it deserves.', 'Closing message for promo email', 'string', TRUE);

-- PMS Email Message Template Configuration - Additional fields
INSERT INTO configuration_settings (category, "key", value, description, data_type, is_editable) VALUES
...
-- Subscription Email Message Template Configuration - Complete fields
INSERT INTO configuration_settings (category, "key", value, description, data_type, is_editable) VALUES
